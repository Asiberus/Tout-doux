...
| Outil                 | État                                                                                                                                                                                                                                                                                                                                              |
| --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Tests                 | **14 tests de fumée** dans `tout_doux/tests.py` (résolution d'URL, knox, DRF, pagination, django-filter, CORS, templates d'e-mail) + **44 tests de non-régression** posés par le chantier N+1 : `test_api_contract.py` (30, forme et valeurs des réponses) et `test_query_counts.py` (14, nombre de requêtes SQL). **Toujours aucun test métier** |
