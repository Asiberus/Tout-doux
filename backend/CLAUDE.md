...
`tout_doux` (12 modèles, 41 sérialiseurs, 17 tests de fumée, 62 tests de non-régression, 0 test
métier). Monorepo :
...
**17 tests de fumée** couvrent la plomberie (`tout_doux/tests.py`), et **62 tests de
