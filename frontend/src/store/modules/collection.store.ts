...
export class CollectionModule extends VuexModule {
    ...
    // Mutations
    @Mutation
    private [collectionMutations.setCurrentCollection](collection: CollectionModel | undefined): void {
    ...
    @Mutation
    private [collectionMutations.updateProperties](payload: { name: string; description: string }): void {
    ...
    @Action
    async [collectionActions.updateProperties](payload: { id: number; data: Partial<CollectionModel> }): Promise<void> {
    ...
    @Action
    async [collectionActions.task.editTask](payload: { id: number; taskForm: Partial<TaskModel> }): Promise<void> {
